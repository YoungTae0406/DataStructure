...
public class Test {
	public static void main(String[] args) {
		...
		DLinkedQueue myQ01 = new DLinkedQueue();
		DLinkedQueue myQ02 = new DLinkedQueue();
		...
		for(int i=1;i<101;i++) { //랜덤한 시간 간격
			if(tempTime==i) {// 객체 생성
				...
				if(myQ01.size() > myQ02.size()) {
					...
					myQ02.add(aC2);
					System.out.println("Time : "+ i + " Service "+aC2.toString()+" arrived."
							+ "Inserted Queue 1.");
					continue;
				...
				if(myQ01.size() == myQ02.size()) {
					...
					myQ01.add(aC);
					System.out.println("Time : "+ i + " Service "+aC.toString()+" arrived."
							+ "Inserted Queue 0.");
					continue;
				}
